...
st.subheader(
     'Top 10 Job titles of the employees')
job_count = df['job_title'].value_counts().head(10)


fig = px.bar(job_count,
              job_count.index,
              job_count.values,
              title=
...
- salary trend on the basis of 
    ...
    - company size  
    - currency
- statistical analysis of different categories vs salary
''')
...
st.subheader("Trend of the salary over the years")
